...
export default function TimeTravel() {
  ...
  const generatePlaylist = async () => {
    ...
    try {
      ...
      if (response.data.tracks.length === 0) {
        setError(
          `No tracks found for the ${selectedEra}s with your taste. This might be due to limited matches for your genres or artists in that era. Try another decade!`,
        )
      }
    } catch (error) {
  ...
  const savePlaylistToSpotify = async () => {
    ...
    try {
      ...
      // Show toast notification with playlist details
      ...
      <main className="relative z-10 py-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <Card className="bg-white/5 backdrop-blur-sm border-white/10 mb-8">
            ...
            <CardContent>
              <Tabs defaultValue={selectedEra} onValueChange={setSelectedEra} className="mb-6">
                <TabsList className="grid grid-cols-3 md:grid-cols-6">
                  {eras.map((era) => (
                    <TabsTrigger key={era.value} value={era.value}>
                      {era.label}
                    </TabsTrigger>
                  ))}
                </TabsList>
